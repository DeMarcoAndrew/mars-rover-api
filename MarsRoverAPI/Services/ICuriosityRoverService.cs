...
namespace MarsRoverAPI.Services
{
    public interface ICuriosityRoverService
    {
        ...
        public Task<IEnumerable<string>> GetCuriosityRoverImagesAsync(int? sol = null, string? earthDate = null, bool? latest = null, int? page = null, int? perPage = null, string? camera = null);
    }
}